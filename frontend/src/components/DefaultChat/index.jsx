...
export default function DefaultChatContainer() {
  ...
  const MESSAGES = [
    ...
    <React.Fragment key="msgCustom">
  <MessageContainer>
    <MessageContent alignmentCls={getMessageAlignment("assistant")}>
      <UserIcon user={{ uid: "system" }} role={"assistant"} />
      <MessageText>
        Check out our custom portal:
      </MessageText>
      <a
        href="/assets/announcements/pages/my-local-page.html"
        target="_blank"
        rel="noreferrer"
        className="mt-1 px-4 py-2 rounded-lg bg-slate-200 text-gray-800 text-sm hover:bg-slate-300 transition-all duration-200"
      >
        Open Portal
      </a>
    </MessageContent>
