...
var _babelParser = _interopRequireDefault(require("./configs/babel-parser.json"));
...
var _default = {
  configs: {
    ...
    'babel-parser': _babelParser["default"]
  },
  rules: _lodash["default"].mapValues(rules, function (rule, key) {
