...
var create = function create(context) {
  ...
  if (always) {
    ...
    var isIgnoredNode = function isIgnoredNode(node) {
      for (var _i = 0, _ignoredNodes = ignoredNodes; _i < _ignoredNodes.length; _i++) {
        var predicate = _ignoredNodes[_i];
    ...
    var _iterator = _createForOfIteratorHelper(sourceCode.ast.body),
        _step;
