...
var create = (0, _utilities.iterateFunctionNodes)(function (context) {
  ...
  return function (functionNode) {
    ...
    _lodash["default"].forEach(functionNode.params, function (identifierNode) {
      ...
      var typeAnnotation;
      typeAnnotation = _lodash["default"].get(identifierNode, 'typeAnnotation') || _lodash["default"].get(identifierNode, 'left.typeAnnotation') || _lodash["default"].get(identifierNode, 'argument.typeAnnotation');
