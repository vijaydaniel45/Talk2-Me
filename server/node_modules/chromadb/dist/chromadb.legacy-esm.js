...
var CohereAISDK56 = class {
  ...
  async loadClient() {
    if (this.cohereClient)
      return;
    const { default: cohere } = await import("./cohere-ai-KNV6FGYZ.mjs");
...
var CohereAISDK7 = class {
  ...
  async loadClient() {
    if (this.cohereClient)
      return;
    const cohere = await import("./cohere-ai-KNV6FGYZ.mjs").then((cohere2) => {
      return cohere2;
    });
...
var CohereEmbeddingFunction = class _CohereEmbeddingFunction {
  ...
  async initCohereClient() {
    if (this.cohereAiApi)
      return;
    try {
      this.cohereAiApi = await import("./cohere-ai-KNV6FGYZ.mjs").then((cohere) => {
...
var GoogleGenerativeAiEmbeddingFunction = class _GoogleGenerativeAiEmbeddingFunction {
  ...
  static async import() {
    try {
      const { GoogleGenerativeAI } = await import("./dist-VKIDZ6QC.mjs");
...
var OllamaEmbeddingFunction = class _OllamaEmbeddingFunction {
  ...
  static async import() {
    try {
      const { ollama } = await import("./dist-O6N5T3JM.mjs").then((m) => ({ ollama: m }));
      return { ollama };
    } catch (e) {
      throw new Error(
...
var OpenAIEmbeddingFunction = class _OpenAIEmbeddingFunction {
  ...
  static async import() {
    try {
      const { default: openai } = await import("./openai-64BKFVCL.mjs");
      const { VERSION } = await import("./version-2PHUJJC6.mjs");
...
var VoyageAIAPI = class {
  ...
  async loadClient() {
    if (this.client)
      return;
    const voyageai = await import("./voyageai-UCHIDVDS.mjs").then((voyageai2) => {
      return voyageai2;
    });
...
var VoyageAIEmbeddingFunction = class _VoyageAIEmbeddingFunction {
  ...
  async initClient() {
    if (this.voyageAiApi)
      return;
    try {
      this.voyageAiApi = await import("./voyageai-UCHIDVDS.mjs").then((voyageai) => {
